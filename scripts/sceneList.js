		...
		case "start": {
			...
			document.getElementById('output').innerHTML +=`
				<div class="disclaimer">
					...
					<p class = "centeredText">Or, you can drop by the new <a href="https://www.reddit.com/r/noodlejacuzzi/">Noodle Jacuzzi Subreddit!</a>. Woooo~!</p>
					...
					<p class = "centeredText"><b>As of July 2nd I'm on vacation! I'll be back in a week or so, sorry if I'm late to a message you send me!</b></p>
				</div>
